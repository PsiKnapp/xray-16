...
protected:
    ...
    void fill_new_spawns_single(SPAWN_GRAPH::CVertex* vertex, SPAWN_IDS& spawns,
        ALife::_TIME_ID game_time, SPAWN_IDS& objects);
    void fill_new_spawns(SPAWN_GRAPH::CVertex* vertex, SPAWN_IDS& spawns, ALife::_TIME_ID game_time,
        SPAWN_IDS& objects);
    IC void process_spawns(SPAWN_IDS& spawns);
    ...
    IC bool spawned_item(CSE_Abstract& abstract, SPAWN_IDS& objects) const;
    IC bool spawned_item(SPAWN_GRAPH::CVertex* vertex, SPAWN_IDS& objects);
    IC bool object_existance_limit(CSE_Abstract& abstract, SPAWN_IDS& objects) const;
    IC bool can_spawn(CSE_Abstract& abstract, ALife::_TIME_ID game_time, SPAWN_IDS& objects) const;
...
public:
    ...
    void fill_new_spawns(SPAWN_IDS& spawns, ALife::_TIME_ID game_time, SPAWN_IDS& objects);
